...
/**
 * TemplateMethod - Base64ImageMethod
 * 自定义模板方法，用于输出bas64编码过后的图片
 *
 * @author lijun
 * @constructor
 */
@Component
open class Base64ImageMethod : TemplateMethodModelEx {

    private val prefix: String = "data:image/png;base64,"
    ...
    override fun exec(arguments: MutableList<Any?>?): Any {
        ...
        return SimpleScalar("$prefix${arguments[0].toString()}")
    }
