...
/**
 * 根据文件名进行排序，供KindEditor调用
 *
 * @author lijun
 * @constructor
 */
class NameComparator : Comparator<Hashtable<String, Any>> {
    ...
    override fun compare(o1: Hashtable<String, Any>?, o2: Hashtable<String, Any>?): Int {
        if (MapUtils.getBooleanValue(o1, "is_dir") && !MapUtils.getBooleanValue(o2, "is_dir")) {
            ...
            return MapUtils.getString(o1, "filename").compareTo(MapUtils.getString(o2, "filename"));
        }
    }
